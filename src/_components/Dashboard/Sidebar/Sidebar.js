    ...
    return (
        <aside id="sidebar" className="sidebar open">
            <div className="top-sidebar">
                ...
                <div className="hidden-sidebar sidebar-username">{userInfo && userInfo.userName || 'Guest User'}</div>
                <div className="hidden-sidebar sidebar-useremail">{userInfo && userInfo.userEmail || 'guestemail@guest.com'}</div>
            </div>
